...
var config = {
  apiKey: "AIzaSyBhYPeb5BMf8JL7gqHOUG1x0ZU12EljnzQ",
  authDomain: "ultra-aloe-129120.firebaseapp.com",
  databaseURL: "https://chat-2af12-default-rtdb.firebaseio.com/",
  projectId: "1:109170548947:web:49914270b0c27700913426",
  storageBucket: "",
  messagingSenderId: "179728860135",
};
...
$(document).ready(function () {
  ...
  function insertChat(who, text, time, user, avatar) {
    ...
    if (who == nameUser) {
      control =
        '<li style="width:100%">' +
        '<div class="msj macro">' +
        '<div class="avatar"><img class="img-circle" style="width:40%;" src="' +
        avatar +
        '" /></div>' +
      ...
      control =
        ...
        "</small></p>" +
        "</div>" +
        '<div class="avatar" style="padding:0px 0px 0px 10px !important"><img class="img-circle" style="width:40%;" src="' +
        avatar +
        '" /></div>' +
        "</li>";
    }
  ...
  commentsRef.on("child_added", function (snap) {
    if (qtdchat != 0) {
      ...
      // A imagem do usuário que enviou a mensagem recebida.
      var avatarusuario = snap.val().avatar;
      //Chama o método para inserir a mensagem recebida no chat
      insertChat(nomeusuario, novamensagem, date, nomeusuario, avatarusuario);
    }
  });
  //**************************************************
});
